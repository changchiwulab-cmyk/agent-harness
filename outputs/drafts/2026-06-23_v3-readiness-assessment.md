...
> ✅ **已套用（2026-06-23，人工確認）**：下列加註已寫入 `memory/.../decisions/20260415-D003*.yaml` 與 `20260509-D007*.yaml`（只加註、未改既有決策內容）。本節保留為提案紀錄。
>
> 以下為 **proposed diff**，已於人工確認後套用。改 decision logs 屬記憶/決策變更（ask）。
